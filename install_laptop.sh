...
echo "[*] Cloning laptop branch of dotfiles..."
...
ln -s "$TARGET_DIR/laptop/config" "$HOME/.config"
echo "✓ Linked .config"
...
ln -s "$TARGET_DIR/laptop/emacs.d" "$HOME/.emacs.d"
echo "✓ Linked .emacs.d"
...
ln -s "$TARGET_DIR/laptop/bashrc" "$HOME/.bashrc"
echo "✓ Linked .bashrc"
...
ln -s "$TARGET_DIR/laptop/zshrc" "$HOME/.zshrc"
echo "✓ Linked .zshrc"

echo "[✔] Laptop dotfiles installed successfully."
