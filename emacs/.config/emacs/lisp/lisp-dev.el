...
(use-package rainbow-delimiters
  ...
  :config
  ;; Also explicitly enable for scheme hooks (covers lazy-load cases)
  (add-hook 'scheme-mode-hook #'rainbow-delimiters-mode)
  (add-hook 'scheme-ts-mode-hook #'rainbow-delimiters-mode)

  ;; If a theme overwrites your faces at startup, set them again after init.
...
;; Enable rainbow in the Gambit REPL (comint) buffer named *gambit*
...
;; Keybindings for Scheme mode (override any Geiser bindings)
