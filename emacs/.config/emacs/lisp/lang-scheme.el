...
;; ----------------------------------------
;; CHICKEN Scheme REPL (csi via comint)
;; ----------------------------------------

;; (defun run-chicken ()
;;   "Run CHICKEN Scheme REPL (csi) in a right vertical split."
;;   (interactive)
...
;; (defun chicken--send (string)
;;   "Low-level sender for CHICKEN csi REPL."
;;   (unless (comint-check-proc "*chicken*")
;;     (set-buffer (make-comint "chicken" "/usr/bin/chicken-csi")))
...
;;   "Send region to CHICKEN REPL."
;;   (interactive "r")
;;   (chicken--send (buffer-substring-no-properties start end)))

;; (defun chicken-send-buffer ()
;;   "Send whole buffer to CHICKEN."
;;   (interactive)
;;   (chicken-send-region (point-min) (point-max)))

;; (defun chicken-send-definition ()
;;   "Send current definition to CHICKEN."
;;   (interactive)
;;   (save-excursion
;;     (mark-defun)
